...
import { Import, OctagonAlertIcon } from 'lucide-react'
                ...
                <div className='flex flex-col gap-3'>
                    <Card className='overflow-hidden shadow-2xl border-0 backdrop-blur-sm bg-white/80'>
                        <CardContent className='grid p-0 md:grid-cols-2'>
                                ...
                                <form onSubmit={form.handleSubmit(onSubmit)} className='p-4 md:p-5 space-y-3'>
                                    <div className='flex flex-col gap-3'>
                                        ...
                                        <div className='text-center text-sm text-slate-600'>
                                            ...
                                            <Link className='font-semibold text-blue-600 hover:text-blue-700 underline-offset-4 hover:underline transition-colors duration-200' href='/auth/sign-up'>
                                                Sign up
                                            </Link>
                                        </div>
                                    </div>
                            ...
                            <div className='bg-gradient-to-br from-blue-900 via-blue-700 to-blue-900 items-center justify-center relative hidden md:flex flex-col overflow-hidden'>
                                ...
                                <div className='relative z-10 flex flex-col items-center space-y-4'>
                                    ...
                                    <div className='text-center space-y-1'>
                                        ...
                                        <p className='text-blue-500 text-base font-medium max-w-xs'>
